...
Deliberately inaccessible C# ASP.NET web application for testing the AODA/WCAG accessibility scanner pipeline.
...
```bash
docker build -t a11y-demo-app-002 .
docker run -p 8080:8080 a11y-demo-app-002
```
